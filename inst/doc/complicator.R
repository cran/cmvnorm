...
###################################################
### code chunk number 7: makesinglesample
###################################################
...
###################################################
### code chunk number 8: estimatebetahat
###################################################
betahat.fun(val,solve(A),d)


###################################################
### code chunk number 9: secondinterp
###################################################
...
###################################################
### code chunk number 10: setupelliptic
###################################################
require("emulator")
require("elliptic")
valsigma <- 
...
###################################################
### code chunk number 11: samplefromsigma
###################################################
dsigma <- apply(valsigma,1,function(u){sigma(u[1],g=u[2:3])})


###################################################
### code chunk number 12: evaluatelikelihood
###################################################
...
###################################################
### code chunk number 13: translatorfunctionse
###################################################
...
###################################################
### code chunk number 14: useoptimhere
###################################################
...
###################################################
### code chunk number 15: testrealvalue
###################################################
...
###################################################
### code chunk number 16: objectiverealvariancematrix
###################################################
ob2 <- function(x){
...
###################################################
### code chunk number 17: likelihoodratiotestforrealA
###################################################
